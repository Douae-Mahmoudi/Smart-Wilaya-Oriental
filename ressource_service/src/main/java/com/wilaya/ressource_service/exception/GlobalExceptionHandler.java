...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> gererViolationContrainte(ConstraintViolationException ex) {
        return construireReponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(org.springframework.orm.ObjectOptimisticLockingFailureException.class)
    public ResponseEntity<Map<String, Object>> gererConflitVerrouillage(
            org.springframework.orm.ObjectOptimisticLockingFailureException ex) {
        return construireReponse(HttpStatus.CONFLICT,
                "Cette ressource a été modifiée entre-temps, veuillez réessayer");
    }
